# ==========================================================================
# InvertedDoublePendulum-v4   (family: mujoco)
# ==========================================================================
# (no built-in description — see https://gymnasium.farama.org/)
#
# ---- quick reference ----------------------------------------------------
...
#   python InvertedDoublePendulum_v4.py --episodes 20            # evaluate
#   python InvertedDoublePendulum_v4.py --render                 # watch it play
# ==========================================================================
import os
import sys
